...
### Idea: 
Building an application that can predict the onset of diabetes or the possible causes of it by indicating the highly relevant factors using multiple Single Algorithm and an ensemble algorithm
